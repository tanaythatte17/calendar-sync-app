  ...
  <Box sx={{ bgcolor: 'background.default', minHeight: '100vh', py: 6 }}>
    <Container maxWidth="md">
      ...
      <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Unified Calendar View.</li>
        ...
        <li><strong>Website</strong> refers to Unified Calendar View, accessible from <Link href="https://calendar-sync-app-frontend.onrender.com/dashboard" target="_blank" rel="noopener">https://calendar-sync-app-frontend.onrender.com/dashboard</Link></li>
      ...
      <ul>
        <li>By email: tanaythatte17@gmail.com</li>
      </ul>
    </Container>
  </Box>
);
